...
* [Aquí tienes un vídeo y más información sobre la importancia de hacer testing y TDD](why.md)
...
14. [Introducción a los tests basados en propiedades](roman-numerals.md) - Practica TDD con la kata de Números Romanos y haz una pequeña introducción a los tests basados en propiedades.
